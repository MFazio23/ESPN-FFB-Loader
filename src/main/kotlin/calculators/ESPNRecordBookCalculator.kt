...
object ESPNRecordBookCalculator {
    ...
    fun getRecordBookFromMatchups(matchups: List<Matchup>, skipCurrentYear: Boolean = true, excludeDeadSlotTeams: Boolean = false): RecordBook =
        RecordBook(
            ...
            mostPointsMatchup = getMostPointsInMatchup(matchups, includePlayoffs = true),
            mostPointsInPlayoffMatchup = getMostPointsInMatchup(matchups, includePlayoffs = false, onlyPlayoffs = true),
            ...
            highestPointsPlus = getHighestPointsPlus(matchups, skipCurrentYear = skipCurrentYear),
            highestPointsPlusWithPlayoffs = getHighestPointsPlus(matchups, includePlayoffs = true, skipCurrentYear = skipCurrentYear),
            lowestPointsPlus = getLowestPointsPlus(matchups, skipCurrentYear = skipCurrentYear),
            lowestPointsPlusWithPlayoffs = getLowestPointsPlus(matchups, includePlayoffs = true, skipCurrentYear = skipCurrentYear),
    ...
    private fun getMostPointsInMatchup(
        ...
        .sortedByDescending { scoreFunction(it.homeScores) + scoreFunction(it.awayScores) }.map { matchup ->
            RecordBookEntry(
